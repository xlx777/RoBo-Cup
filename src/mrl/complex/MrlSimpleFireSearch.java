...
public class MrlSimpleFireSearch extends Search {
    ...
    public MrlSimpleFireSearch(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
