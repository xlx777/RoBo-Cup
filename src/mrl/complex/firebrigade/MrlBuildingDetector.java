...
import mrl.complex.firebrigade.directionbased.DirectionBasedTargetSelector14;
...
public class MrlBuildingDetector extends BuildingDetector {
    ...
    public MrlBuildingDetector(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        exploreManager = moduleManager.getModule("FireBrigadeSearch.ExploreManager", "mrl.complex.firebrigade.TargetBaseExploreManager");
