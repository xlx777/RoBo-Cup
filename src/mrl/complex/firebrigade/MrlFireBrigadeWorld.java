...
import mrl.world.helper.PropertyHelper;
...
//   ProcessAreaVisibility.process(this, config);
    ...
    @Override
    public MrlWorldHelper precompute(PrecomputeData precomputeData) {//procomputer data calc
    ...
    @Override
    public MrlWorldHelper resume(PrecomputeData precomputeData) {//procumputer data resume
    ...
    @Override
    public MrlWorldHelper preparate() {//nonprecomputer
        super.preparate();
