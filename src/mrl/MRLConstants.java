...
public interface MRLConstants {
    ...
    public static final boolean DEBUG_MESSAGING = true;
    public static final boolean DEBUG_SAY = true;
    public static final boolean DEBUG_PLANNER = true;
    public static final boolean DEBUG_SEARCH = true;
    public static final boolean DEBUG_LA = true;
    public static final boolean DEBUG_RENDEZVOUS_ACTION = true;
    public static final boolean DEBUG_AMBULANCE_TEAM = true;
    public static final boolean DEBUG_FIRE_BRIGADE = true;
    public static final boolean DEBUG_POLICE_FORCE = true;
    public static final boolean DEBUG_POLICE_FORCE_CLEAR = true;
    ...
    public static final boolean SEARCH_INSIDE_BUILDINGS = true;
